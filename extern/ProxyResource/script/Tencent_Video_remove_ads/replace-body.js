...
可改写为Loon的脚本复写：
[Script] 
http-response https://service.ilovepdf.com/v1/user requires-body=true, script-path = https://loon.126996.xyz/Resource/Script/CommonScript/replace-body.js, argument = false->true
